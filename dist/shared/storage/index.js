...
export const uploadFile = async (options) => {
    ...
    try {
        ...
        throw new ValidationError(`Error al subir archivo: ${error instanceof Error ? error.message : 'Error desconocido'}`);
    }
};
/**
...
export const deleteFile = async (key) => {
    ...
    try {
        ...
        throw new ValidationError(`Error al eliminar archivo: ${error instanceof Error ? error.message : 'Error desconocido'}`);
    }
};
/**
...
export const getSignedUrl = async (options) => {
    ...
    try {
        ...
        throw new ValidationError(`Error al generar URL firmada: ${error instanceof Error ? error.message : 'Error desconocido'}`);
    }
};
/**
 ...
 */
export const generateFileKey = (prefix, extension) => {
