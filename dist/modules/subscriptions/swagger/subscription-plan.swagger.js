 ...
 */
const SubscriptionPlanSchema = registry.register('SubscriptionPlan', z.object({
    ...
    features: z
        ...
        limits: z
            ...
            .optional()
            .describe('Límites adicionales por plan (ej. areas, prestadores, activos). FREE usa 1 en cada uno.'),
        functionalities: z
            .array(z.string())
            .optional()
...
const SubscriptionPlanResponseSchema = registry.register('SubscriptionPlanResponse', z.object({
    success: z.literal(true),
    data: SubscriptionPlanSchema,
    message: z.string().optional(),
    timestamp: z.string().datetime().optional(),
}));
const SubscriptionPlanListResponseSchema = registry.register('SubscriptionPlanListResponse', z.object({
    success: z.literal(true),
...
registry.registerPath({
    ...
    description: 'Lista los planes disponibles con precios mensuales en MXN, límites (usuarios, eventos, actividades) y features. Público; no requiere autenticación. Útil para mostrar comparativa en el frontend.',
    request: {
...
registry.registerPath({
    ...
    description: 'Devuelve un plan con precios en MXN (priceMonthly como referencia mensual), límites y features. Público.',
    request: {
        params: z.object({
...
//# sourceMappingURL=subscription-plan.swagger.js.map