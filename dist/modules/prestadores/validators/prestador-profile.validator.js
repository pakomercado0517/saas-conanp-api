 ...
 */
export const CreatePrestadorProfileSchema = registry.register('CreatePrestadorProfile', z
    .object({
    userId: z
        .string({
 ...
 */
export const UpdatePrestadorProfileSchema = registry.register('UpdatePrestadorProfile', z
    .object({
 ...
 */
export const ListPrestadoresSchema = registry.register('ListPrestadores', z
    .object({
    page: z.coerce
