...
registry.registerPath({
    ...
    description: 'Lista prestadores distintos con al menos un permiso cuya actividad pertenece al área. Cada elemento incluye `prestador` (perfil y usuario) y `permisos` (todos los permisos de ese prestador en el área). La paginación cuenta prestadores; el orden es por el permiso más reciente del prestador en el área.',
    security: [{ bearerAuth: [] }],
    request: {
        params: z.object({
