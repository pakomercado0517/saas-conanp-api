 ...
 */
export const validateCreatePrestadorProfile = (req, res, next) => {
    try {
 ...
 * @param next - NextFunction de Express
 */
export const validateUpdatePrestadorProfile = (req, res, next) => {
    try {
        // Validar y transformar el body usando el schema Zod
 ...
 * @param next - NextFunction de Express
 */
export const validateListPrestadores = (req, res, next) => {
    try {
