 ...
 */
export const validateReporteEventosPorActividad = (req, res, next) => {
    try {
 ...
 */
export const validateReporteEventosPorPrestador = (req, res, next) => {
    try {
 ...
 */
export const validateReporteEventosPorFecha = (req, res, next) => {
    try {
 ...
 */
export const validateReporteCapacidadUtilizada = (req, res, next) => {
    try {
