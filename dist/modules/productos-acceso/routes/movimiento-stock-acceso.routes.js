 ...
 */
const movimientoStockAccesoRouter = Router({ mergeParams: true });
movimientoStockAccesoRouter.get('/', authenticate, requireOrganizationAccess, validateListMovimientosStock, listMovimientos);
export default movimientoStockAccesoRouter;
//# sourceMappingURL=movimiento-stock-acceso.routes.js.map