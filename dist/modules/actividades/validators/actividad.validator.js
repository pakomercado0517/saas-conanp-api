 ...
 */
export const CreateActividadSchema = registry.register('CreateActividad', z
    .object({
    organizationId: z
        .string()
        .uuid({
 ...
 */
export const UpdateActividadSchema = registry.register('UpdateActividad', z
    .object({
    name: z
        .string()
        .min(1, {
 ...
 */
export const ListActividadesSchema = registry.register('ListActividades', z.object({
    page: z.coerce
        .number()
