export { CreateCapacidadSchema, UpdateCapacidadSchema, VerificarDisponibilidadSchema, } from '../../../modules/capacidad/validators/capacidad.validator.js';
import { z } from 'zod';
...
export const CreateCapacidadSchema = z.object({
     ...
     * Schema Zod para crear capacidad
     */
    const: CreateCapacidadSchema = registry.register('CreateCapacidad', z
        .object({
        actividadId: z
            .string({
            message: 'El ID de actividad es requerido y debe ser un texto',
    ...
    type, CreateCapacidadDTO = (z.infer),
    /**
     * Schema Zod para actualizar capacidad
     */
    const: UpdateCapacidadSchema = registry.register('UpdateCapacidad', z
        .object({
    ...
    type, UpdateCapacidadDTO = (z.infer),
    /**
     * Schema Zod para verificar disponibilidad
     */
    const: VerificarDisponibilidadSchema = registry.register('VerificarDisponibilidad', z
        .object({
        actividadId: z
            .string({
            message: 'El ID de actividad es requerido y debe ser un texto',
        ...
        bloqueId: z
            ...
            type, VerificarDisponibilidadDTO = (z.infer)
        })
    }))
});
