 ...
 */
const ActividadSchema = registry.register('Actividad', z.object({
 ...
 */
const ActividadResponseSchema = registry.register('ActividadResponse', z.object({
 ...
 */
const ActividadListResponseSchema = registry.register('ActividadListResponse', z.object({
    success: z.literal(true).describe('Indica que la operación fue exitosa'),
...
registry.registerPath({
    ...
    description: 'Crea una nueva actividad turística en una organización (ANP). Solo administradores pueden crear actividades. La actividad define qué tipo de operación turística puede realizarse, su tipo de agenda (bloques predefinidos o horario libre), y reglas como si requiere guía.',
    security: [{ bearerAuth: [] }],
    request: {
        params: z.object({
...
registry.registerPath({
    ...
    description: 'Obtiene la lista de actividades de una organización con paginación y filtros. Permite filtrar por tipo, tipo de agenda, estado activo, y si requiere guía. Cualquier usuario con acceso a la organización puede listar actividades.',
    security: [{ bearerAuth: [] }],
    request: {
        params: z.object({
            organizationId: z.string().uuid().describe('ID de la organización'),
...
registry.registerPath({
    ...
    description: 'Obtiene los detalles completos de una actividad específica. Cualquier usuario con acceso a la organización puede obtener actividades.',
    security: [{ bearerAuth: [] }],
    request: {
        params: z.object({
            organizationId: z.string().uuid().describe('ID de la organización'),
...
registry.registerPath({
    ...
    description: 'Actualiza una actividad existente. Solo administradores pueden actualizar actividades. Al menos un campo es requerido. Se puede cambiar el tipo de agenda, nombre, nivel de impacto, etc.',
    security: [{ bearerAuth: [] }],
    request: {
        params: z.object({
            organizationId: z.string().uuid().describe('ID de la organización'),
...
registry.registerPath({
    ...
    description: 'Elimina una actividad (soft delete). Solo administradores pueden eliminar actividades. La actividad se marca como eliminada pero no se borra de la base de datos, permitiendo auditoría histórica.',
    security: [{ bearerAuth: [] }],
    request: {
        params: z.object({
            organizationId: z.string().uuid().describe('ID de la organización'),
...
//# sourceMappingURL=actividad.swagger.js.map