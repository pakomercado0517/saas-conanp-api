 ...
 */
const bloqueRouter = Router({ mergeParams: true });
/**
 ...
 * }
 */
bloqueRouter.post('/from-template', authenticate, requireOrganizationAccess, requireAdmin, validateCreateBloqueFromTemplate, createBloqueFromTemplate);
/**
 ...
 * }
 */
bloqueRouter.patch('/:bloqueId', authenticate, requireOrganizationAccess, requireAdmin, validateUpdateBloque, updateBloque);
/**
 ...
 */
bloqueRouter.delete('/:bloqueId', authenticate, requireOrganizationAccess, requireAdmin, deleteBloque);
/**
 ...
 * Requiere autenticación y acceso a la organización (middleware requireOrganizationAccess)
 */
const bloqueActividadRouter = Router({ mergeParams: true });
/**
 * Middleware para inyectar actividadId desde params al body
 * (para rutas anidadas bajo actividades)
 */
const injectActividadIdFromParams = (req, _res, next) => {
 ...
 * }
 */
bloqueActividadRouter.post('/', authenticate, requireOrganizationAccess, requireAdmin, injectActividadIdFromParams, validateCreateBloque, createBloque);
/**
 ...
 * }
 */
bloqueActividadRouter.get('/', authenticate, requireOrganizationAccess, validateListBloques, listBloquesByActividad);
export default bloqueRouter;
export { bloqueActividadRouter };
//# sourceMappingURL=bloque.routes.js.map