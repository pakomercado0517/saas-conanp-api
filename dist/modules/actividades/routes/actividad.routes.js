 ...
 */
const actividadRouter = Router({ mergeParams: true });
/**
 ...
 * }
 */
actividadRouter.post('/', authenticate, requireOrganizationAccess, requireAdmin, validateCreateActividad, createActividad);
/**
 ...
 * }
 */
actividadRouter.patch('/:actividadId', authenticate, requireOrganizationAccess, requireAdmin, validateUpdateActividad, updateActividad);
/**
 ...
 */
actividadRouter.delete('/:actividadId', authenticate, requireOrganizationAccess, requireAdmin, deleteActividad);
