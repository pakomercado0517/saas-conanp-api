...
const PaymentResponseSchema = registry.register('PaymentResponse', z.object({
    id: z.string().uuid(),
...
const PaymentIntentResponseSchema = registry.register('PaymentIntentResponse', z.object({
    id: z.string().uuid(),
    organizationId: z.string().uuid(),
    eventoId: z.string().uuid(),
...
const PaginatedPaymentsResponseSchema = registry.register('PaginatedPaymentsResponse', z.object({
...
registry.registerPath({
    ...
    description: 'Crea un Payment Intent en Stripe y guarda el pago en la base de datos. El pago se crea con estado "pending" y se actualiza cuando se confirma.',
    tags: ['Pagos'],
    security: [{ bearerAuth: [] }],
    parameters: [
        {
...
registry.registerPath({
    ...
    description: 'Confirma un pago actualizando el PaymentIntent en Stripe y el registro en la base de datos.',
    tags: ['Pagos'],
    security: [{ bearerAuth: [] }],
    parameters: [
        {
...
registry.registerPath({
    ...
    description: 'Lista pagos con paginación y filtros. Solo se muestran pagos de la organización a la que el usuario tiene acceso.',
    tags: ['Pagos'],
    security: [{ bearerAuth: [] }],
    parameters: [
        {
...
registry.registerPath({
    ...
    description: 'Obtiene un pago por ID. Solo se puede ver si el pago pertenece a la organización del usuario.',
    tags: ['Pagos'],
    security: [{ bearerAuth: [] }],
    parameters: [
        {
...
registry.registerPath({
    ...
    description: 'Procesa un reembolso para un pago. Puede ser reembolso total (si no se proporciona amount) o parcial (si se proporciona amount). Solo los administradores pueden procesar reembolsos.',
    tags: ['Pagos'],
    security: [{ bearerAuth: [] }],
    parameters: [
        {
