...
export const CreateDependenciaSchema = registry.register('CreateDependencia', z.object({
    name: z
...
export const UpdateDependenciaSchema = registry.register('UpdateDependencia', z
    .object({
...
const SORT_FIELDS = ['name', 'createdAt', 'updatedAt'];
export const ListDependenciasSchema = registry.register('ListDependencias', z.object({
...
export const CreateAreaUnderDependenciaSchema = registry.register('CreateAreaUnderDependencia', z.object({
    name: z
...
//# sourceMappingURL=dependencia.validator.js.map