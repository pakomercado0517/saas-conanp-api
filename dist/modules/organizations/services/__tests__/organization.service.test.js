...
vi.mock('@/modules/areas/models/area.model.js', () => ({
    Area: {
        ...
        findAndCountAll: (...args) => mockAreaFindAndCountAll(...args),
        create: (...args) => mockAreaCreate(...args),
    },
}));
vi.mock('@/modules/dependencias/models/dependencia.model.js', () => ({
    Dependencia: {
        create: (...args) => mockDependenciaCreate(...args),
    },
}));
...
describe('organization.service', () => {
    ...
    describe('createOrganization', () => {
        it('creates organization without access check', async () => {
            ...
            expect(mockAreaCreate).toHaveBeenCalledWith(expect.objectContaining({
                dependenciaId: DEPENDENCIA_ID,
                name: 'Test Org',
                ecosystem_type: 'terrestre',
                settings: {},
