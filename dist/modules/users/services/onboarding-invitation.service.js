 ...
 */
export const createOnboardingInvitation = async (email, invitedByUserId, invitedByEmail) => {
 ...
 */
export const validateOnboardingInvitationToken = async (invitationId, token) => {
 ...
 */
export const consumeOnboardingInvitationForRegistration = async (invitationId, token, email) => {
    const invitation = await OnboardingInvitation.findByPk(invitationId);
    if (!invitation) {
        throw new NotFoundError('Invitación de onboarding', { invitationId });
    }
    ...
    logger.info({ invitationId, email: emailNormalized }, 'Invitación de onboarding consumida para registro');
    return { type: 'onboarding' };
};
//# sourceMappingURL=onboarding-invitation.service.js.map