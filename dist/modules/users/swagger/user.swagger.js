 ...
 */
const UserProfileSchema = registry.register('UserProfile', z.object({
 ...
 */
const UserProfileResponseSchema = registry.register('UserProfileResponse', z.object({
...
registry.registerPath({
    ...
    description: 'Obtiene el perfil completo del usuario autenticado. Requiere token JWT válido en el header Authorization.',
    security: [{ bearerAuth: [] }],
    responses: {
        200: {
...
registry.registerPath({
    ...
    description: 'Actualiza el perfil del usuario autenticado. Permite cambiar email y/o nombre. Al menos un campo es requerido.',
    security: [{ bearerAuth: [] }],
    request: {
        body: {
            content: {
...
registry.registerPath({
    ...
    description: 'Cambia la contraseña del usuario autenticado. Requiere la contraseña actual para verificar identidad. La nueva contraseña debe ser diferente de la actual.',
    security: [{ bearerAuth: [] }],
    request: {
        body: {
            content: {
...
**Nota:** Esta acción es irreversible. Los datos se anonimizan y no se pueden recuperar.`,
    ...
    responses: {
        ...
        400: {
            description: 'Error de validación - El usuario tiene membresías activas u otras restricciones',
            content: {
                'application/json': {
                    schema: commonErrorResponses[400].content['application/json'].schema,
                    examples: {
                        activeMemberships: {
                            ...
                            value: {
                                success: false,
                                error: 'Error de validación',
                                message: 'No puedes eliminar tu cuenta mientras tengas membresías activas en organizaciones. Contacta a los administradores.',
