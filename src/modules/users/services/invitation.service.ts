...
import type {
  CreateInvitationDTO,
  ListInvitationsDTO,
} from '@/modules/users/validators/invitation.validator.js';
import {
  NotFoundError,
  ConflictError,
  ForbiddenError,
...
const generateInvitationToken = async (): Promise<{ token: string; tokenHash: string }> => {
...
export const createInvitation = async (
  ...
  try {
    ...
    throw new BadRequestError(
      'La invitación se creó pero no se pudo enviar el correo. El administrador puede compartir el enlace o el código manualmente.'
    );
  }
 ...
 */
export const consumeInvitationForRegistration = async (
  invitationId: UUID,
  token: string,
  email: string
