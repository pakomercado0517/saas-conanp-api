 ...
 * @param next - NextFunction de Express
 */
export const validateCreateMembership = (req: Request, res: Response, next: NextFunction): void => {
  try {
    // Validar y transformar el body usando el schema Zod
 ...
 * @param next - NextFunction de Express
 */
export const validateUpdateMembership = (req: Request, res: Response, next: NextFunction): void => {
  try {
    // Validar y transformar el body usando el schema Zod
 ...
 * @param next - NextFunction de Express
 */
export const validateListMemberships = (req: Request, res: Response, next: NextFunction): void => {
  try {
...
export const validateCreateInvitation = (req: Request, res: Response, next: NextFunction): void => {
  try {
...
export const validateListInvitations = (req: Request, res: Response, next: NextFunction): void => {
  try {
