 ...
 */
const MembershipResponseSchema = registry.register(
  'MembershipResponse',
  z.object({
 ...
 */
const MembershipListResponseSchema = registry.register(
...
registry.registerPath({
  ...
  description:
    'Crea una nueva membresía invitando a un usuario a una organización. Solo administradores pueden invitar usuarios. El usuario debe existir previamente en el sistema.',
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
      organizationId: z.string().uuid().describe('ID de la organización'),
...
registry.registerPath({
  ...
  description:
    'Obtiene la lista de membresías de una organización con paginación y filtros. Incluye información del usuario y organización en cada membresía.',
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
      organizationId: z.string().uuid().describe('ID de la organización'),
...
registry.registerPath({
  ...
  description:
    'Actualiza el rol y/o estado de una membresía existente. Solo administradores pueden actualizar membresías. Al menos un campo es requerido.',
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
      organizationId: z.string().uuid().describe('ID de la organización'),
...
registry.registerPath({
  ...
  description:
    'Elimina una membresía, removiendo al usuario de la organización. Solo administradores pueden eliminar membresías. La membresía se elimina permanentemente de la base de datos.',
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
      organizationId: z.string().uuid().describe('ID de la organización'),
