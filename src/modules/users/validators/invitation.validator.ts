...
export const CreateInvitationSchema = registry.register(
  'CreateInvitation',
  z
    .object({
      email: z
...
export const ListInvitationsSchema = registry.register(
  'ListInvitations',
  z.object({
...
export const ValidateInvitationTokenSchema = registry.register(
