...
import {
  createOrUpdateCapacidad,
  verificarDisponibilidad,
} from '../controllers/capacidad.controller.js';
import {
  validateCreateCapacidad,
 ...
 */
const capacidadActividadRouter: ExpressRouter = Router({ mergeParams: true });
