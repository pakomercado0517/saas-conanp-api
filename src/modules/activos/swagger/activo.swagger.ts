...
const ActivoResponseSchema = registry.register(
  'ActivoResponse',
  z.object({
...
const ActivoListResponseSchema = registry.register(
  'ActivoListResponse',
  z.object({
    success: z.literal(true),
...
const ActivoRequisitoSchema = registry.register(
  'ActivoRequisito',
  z.object({
...
const ActivoRequisitoResponseSchema = registry.register(
  'ActivoRequisitoResponse',
  z.object({
    success: z.literal(true),
...
const ActivoRequisitoListResponseSchema = registry.register(
  'ActivoRequisitoListResponse',
  z.object({
    success: z.literal(true),
...
registry.registerPath({
  ...
  description:
    'Crea un nuevo activo (embarcación, vehículo, guía o equipo) para un prestador. Solo administradores pueden crear activos.',
  security: [{ bearerAuth: [] }],
  request: {
...
registry.registerPath({
  ...
  description:
    'Actualiza campos de un activo existente. Solo administradores pueden actualizar activos.',
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
      organizationId: z.string().uuid().describe('ID de la organización'),
...
registry.registerPath({
  ...
  description:
    'Aprueba un activo cambiando su estado a "aprobado". Solo administradores pueden aprobar activos.',
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
      organizationId: z.string().uuid().describe('ID de la organización'),
...
registry.registerPath({
  ...
  description:
    'Crea un requisito para un activo (documentos, certificados, etc.). Solo administradores pueden crear requisitos.',
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
      organizationId: z.string().uuid().describe('ID de la organización'),
...
registry.registerPath({
  ...
  description:
    'Actualiza un requisito de activo existente. Solo administradores pueden actualizar requisitos.',
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
      organizationId: z.string().uuid().describe('ID de la organización'),
