 ...
 */
export const validateCreateActivo = (req: Request, res: Response, next: NextFunction): void => {
  try {
 ...
 * @param next - NextFunction de Express
 */
export const validateUpdateActivo = (req: Request, res: Response, next: NextFunction): void => {
  try {
    // Validar y transformar el body usando el schema Zod
 ...
 * @param next - NextFunction de Express
 */
export const validateListActivos = (req: Request, res: Response, next: NextFunction): void => {
  try {
 ...
 * @param next - NextFunction de Express
 */
export const validateCreateActivoRequisito = (
  req: Request,
  res: Response,
  next: NextFunction
): void => {
 ...
 * @param next - NextFunction de Express
 */
export const validateUpdateActivoRequisito = (
  req: Request,
  res: Response,
  next: NextFunction
): void => {
 ...
 * @param next - NextFunction de Express
 */
export const validateListActivoRequisitos = (
  req: Request,
  res: Response,
  next: NextFunction
): void => {
