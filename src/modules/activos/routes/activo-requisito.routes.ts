...
import {
  ...
  updateRequisito,
  deleteRequisito,
} from '../controllers/activo-requisito.controller.js';
import {
  validateCreateActivoRequisito,
  validateUpdateActivoRequisito,
  validateListActivoRequisitos,
 ...
 */
const activoRequisitoRouter: ExpressRouter = Router({ mergeParams: true });
