...
import {
  ...
  ListDependenciasSchema,
  CreateAreaUnderDependenciaSchema,
} from '../validators/dependencia.validator.js';

const DependenciaSchema = registry.register(
  'Dependencia',
  z.object({
...
const DependenciaResponseSchema = registry.register(
  'DependenciaResponse',
  z.object({
...
const DependenciaListResponseSchema = registry.register(
...
const AreaListResponseSchema = registry.register(
  'AreaListResponse',
  z.object({
    success: z.literal(true),
...
registry.registerPath({
  ...
  description:
    'Crea una dependencia. El usuario queda como owner (DependenciaMembership). Se crea suscripción FREE. No crea área; usar POST /dependencias/:dependenciaId/areas para crear áreas. Plan FREE: 1 dependencia por usuario.',
  security: [{ bearerAuth: [] }],
  request: {
    body: {
      content: {
...
registry.registerPath({
  ...
  description:
    'Lista dependencias a las que el usuario tiene acceso (por DependenciaMembership o por área).',
  security: [{ bearerAuth: [] }],
  request: {
...
registry.registerPath({
  ...
  description:
    'Detalle de una dependencia. Requiere acceso (DependenciaMembership o membresía en alguna área).',
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
...
registry.registerPath({
  ...
  description:
    'Lista áreas (ANPs) de la dependencia. Requiere acceso. Acepta paginación (query: page, limit).',
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
      dependenciaId: z.string().uuid().describe('ID de la dependencia'),
