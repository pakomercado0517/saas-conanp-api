 ...
 */
export const CreateCapacidadSchema = registry.register(
  'CreateCapacidad',
  z
    .object({
      actividadId: z
 ...
 */
export const UpdateCapacidadSchema = registry.register(
  'UpdateCapacidad',
  z
    .object({
 ...
 */
export const VerificarDisponibilidadSchema = registry.register(
