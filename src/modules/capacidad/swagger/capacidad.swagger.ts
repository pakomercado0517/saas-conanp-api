 ...
 */
const CapacidadSchema = registry.register(
  'Capacidad',
  z.object({
...
const CapacidadResponseSchema = registry.register(
  'CapacidadResponse',
  z.object({
...
const CapacidadListResponseSchema = registry.register(
...
registry.registerPath({
  ...
  description:
    'Crea una capacidad para una actividad en una fecha determinada. Si ya existe una capacidad para esa fecha, se actualiza. Solo administradores pueden crear/actualizar capacidades.',
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
...
registry.registerPath({
  ...
  description:
    'Verifica si hay disponibilidad para una actividad en una fecha o en un bloque específico. Para actividades con agenda BLOQUES, incluir `bloqueId` en query.',
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
      organizationId: z.string().uuid().describe('ID de la organización'),
