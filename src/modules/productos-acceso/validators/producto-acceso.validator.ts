...
const TIPO_VALUES = ['brazalete', 'pasaporte'] as const;
 ...
 */
export const CreateProductoAccesoSchema = registry.register(
 ...
 */
export const UpdateProductoAccesoSchema = registry.register(
...
const SORT_FIELDS = ['name', 'tipo', 'vigenciaDias', 'active', 'createdAt', 'updatedAt'] as const;

/**
 * Schema Zod para listar productos de acceso (query params)
 */
export const ListProductosAccesoSchema = registry.register(
  'ListProductosAcceso',
  z.object({
    page: z.coerce
      .number()
