...
const MOTIVO_ENTRADA = ['compra', 'ajuste', 'devolucion'] as const;
 ...
 */
export const EntradaStockSchema = registry.register(
  'EntradaStock',
  z
    .object({
      cantidad: z
 ...
 */
export const SalidaStockSchema = registry.register(
  'SalidaStock',
  z
    .object({
      cantidad: z
...
const SORT_FIELDS = ['fecha', 'cantidad', 'tipo', 'motivo', 'createdAt'] as const;

/**
 * Schema para listar movimientos (query params)
 */
export const ListMovimientosStockSchema = registry.register(
