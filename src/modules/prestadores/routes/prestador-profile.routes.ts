...
import {
  ...
  listPrestadores,
  listPrestadoresConPermisosPorArea,
...
import {
  ...
  validateUpdatePrestadorProfile,
  validateListPrestadores,
 ...
 */
const prestadorRouter: ExpressRouter = Router({ mergeParams: true });
...
prestadorRouter.get(
  ...
  authenticate,
  requireOrganizationAccess,
  validateListPrestadoresConPermisosPorArea,
  listPrestadoresConPermisosPorArea
);
