...
const BloqueResponseSchema = registry.register(
  'BloqueResponse',
  z.object({
...
const BloqueListResponseSchema = registry.register(
  'BloqueListResponse',
  z.object({
    success: z.literal(true).describe('Indica que la operación fue exitosa'),
...
registry.registerPath({
  ...
  description:
    'Crea un nuevo bloque horario para una actividad. Puede ser una plantilla (`isTemplate=true`) o un bloque con fecha específica. Solo administradores pueden crear bloques.',
  security: [{ bearerAuth: [] }],
  request: {
