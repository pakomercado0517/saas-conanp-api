...
const eventoStatusEnum = registry.register(
  'EventoStatus',
  z
 ...
 */
export const CreateEventoSchema = registry.register(
  'CreateEvento',
  z
    .discriminatedUnion('agendaType', [
      ...
      z
        .object({
          ...
          endTime: timeOnlySchema.describe(
            'Hora de fin del evento en formato HH:mm:ss (debe ser posterior a startTime)'
          ),
          capacityOverride: z
            .boolean({ message: 'capacityOverride debe ser true o false' })
            .optional()
    ...
    .refine(
      ...
      {
        message:
          'Si capacityOverride es true, debes indicar capacityOverrideReason (motivo del override).',
 ...
 */
export const UpdateEventoSchema = registry.register(
  'UpdateEvento',
  z
    .object({
      ...
      startTime: optionalTimeOnlySchema.describe(
        'Hora de inicio del evento en formato HH:mm:ss (opcional)'
      ),
      endTime: optionalTimeOnlySchema.describe(
        'Hora de fin del evento en formato HH:mm:ss (opcional)'
      ),
      peopleCount: z
        .number({
          message: 'El número de personas debe ser un número',
 ...
 */
export const ListEventosSchema = registry.register(
  'ListEventos',
  z.object({
    page: z.coerce
