...
export const createEvento = async (req: Request, res: Response): Promise<Response> => {
  ...
  const data = req.body as CreateEventoDTO;
...
export const listEventos = async (req: Request, res: Response): Promise<Response> => {
  ...
  const filters =
    (req.validatedQuery as ListEventosDTO | undefined) ?? (req.query as unknown as ListEventosDTO);
...
export const updateEvento = async (req: Request, res: Response): Promise<Response> => {
  ...
  const eventoId = req.params['eventoId'] as string;
  const userId = req.user.userId;
  const data = req.body as UpdateEventoDTO;
