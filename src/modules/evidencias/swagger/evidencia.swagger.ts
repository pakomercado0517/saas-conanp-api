...
const EvidenciaAmbientalSchema = registry.register(
  'EvidenciaAmbiental',
  z.object({
...
const EvidenciaResponseSchema = registry.register(
  'EvidenciaResponse',
  z.object({
...
const EvidenciaListResponseSchema = registry.register(
...
const EvidenciaCreatedResponseSchema = registry.register(
  'EvidenciaCreatedResponse',
  z.object({
    success: z.literal(true),
    data: EvidenciaAmbientalSchema,
    message: z.string().optional(),
...
const EvidenciaUpdatedResponseSchema = registry.register(
  'EvidenciaUpdatedResponse',
  z.object({
    success: z.literal(true),
    data: EvidenciaAmbientalSchema,
    message: z.string().optional(),
...
registry.registerPath({
  ...
  description:
    'Crea una nueva evidencia ambiental asociada a un evento operativo. Puede incluir un archivo subido o una URL de archivo existente.',
...
registry.registerPath({
  ...
  description:
    'Obtiene una lista paginada de evidencias ambientales asociadas a un evento operativo, con opciones de filtrado y ordenamiento.',
  tags: ['Evidencias Ambientales'],
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
...
registry.registerPath({
  ...
  description:
    'Actualiza los datos de una evidencia ambiental existente. Puede reemplazar el archivo o actualizar otros campos.',
  tags: ['Evidencias Ambientales'],
  security: [{ bearerAuth: [] }],
  request: {
    params: z.object({
