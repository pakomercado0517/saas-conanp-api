 ...
 */
export const validateCreateEvidencia = (req: Request, res: Response, next: NextFunction): void => {
  try {
 ...
 * @param next - NextFunction de Express
 */
export const validateUpdateEvidencia = (req: Request, res: Response, next: NextFunction): void => {
  try {
 ...
 * @param next - NextFunction de Express
 */
export const validateListEvidencias = (req: Request, res: Response, next: NextFunction): void => {
  try {
