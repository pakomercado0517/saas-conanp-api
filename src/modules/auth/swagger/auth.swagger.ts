 ...
 */
const UserDataSchema = registry.register(
  'UserData',
  z.object({
            ...
            success: {
              ...
              value: {
                ...
                data: {
                  ...
                  accessToken:
                    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJhMWIyYzNkNCJ9.abc123',
                  refreshToken:
                    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJhMWIyYzNkNCIsInR5cGUiOiJyZWZyZXNoIn0.xyz789',
                  expiresIn: 3600,
                },
...
registry.registerPath({
  ...
  description:
    'Obtiene un nuevo access token usando un refresh token válido. Úsalo cuando el accessToken expire.',
  request: {
    body: {
      content: {
        'application/json': {
          ...
          examples: {
            success: {
              ...
              value: {
                ...
                data: {
                  accessToken:
                    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJhMWIyYzNkNCJ9.newtoken123',
                  expiresIn: 3600,
                },
...
registry.registerPath({
  ...
  description:
    'Valida el token JWT actual y retorna información del usuario autenticado. Requiere token válido en el header Authorization.',
  security: [{ bearerAuth: [] }],
  responses: {
    200: {
