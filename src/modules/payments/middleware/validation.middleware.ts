 ...
 * @param next - NextFunction de Express
 */
export const validateConfirmPayment = (req: Request, res: Response, next: NextFunction): void => {
  try {
    // Validar y transformar el body usando el schema Zod
 ...
 * @param next - NextFunction de Express
 */
export const validateListPayments = (req: Request, res: Response, next: NextFunction): void => {
  try {
