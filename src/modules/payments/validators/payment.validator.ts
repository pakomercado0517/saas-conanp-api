...
const ALLOWED_CURRENCIES = ['MXN', 'USD'] as const;
...
const optionalCurrencySchema = z.preprocess(
  ...
  z
    .string()
    .refine((val) => ALLOWED_CURRENCIES.includes(val as (typeof ALLOWED_CURRENCIES)[number]), {
...
const PAYMENT_STATUSES_TUPLE: [PaymentStatus, ...PaymentStatus[]] = [
  'pending',
  'processing',
  'succeeded',
  'failed',
