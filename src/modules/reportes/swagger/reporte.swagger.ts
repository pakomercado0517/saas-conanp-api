...
const ReporteEventosPorActividadItemSchema = registry.register(
...
const ReporteEventosPorPrestadorItemSchema = registry.register(
...
const ReporteEventosPorFechaItemSchema = registry.register(
...
const ReporteCapacidadUtilizadaItemSchema = registry.register(
...
const ReportePrestadoresActivosItemSchema = registry.register(
...
const ReporteEventosPorActividadResponseSchema = registry.register(
  'ReporteEventosPorActividadResponse',
  z.array(ReporteEventosPorActividadItemSchema)
);

const ReporteEventosPorPrestadorResponseSchema = registry.register(
  'ReporteEventosPorPrestadorResponse',
  z.array(ReporteEventosPorPrestadorItemSchema)
);

const ReporteEventosPorFechaResponseSchema = registry.register(
  'ReporteEventosPorFechaResponse',
  z.array(ReporteEventosPorFechaItemSchema)
);

const ReporteCapacidadUtilizadaResponseSchema = registry.register(
  'ReporteCapacidadUtilizadaResponse',
  z.array(ReporteCapacidadUtilizadaItemSchema)
);

const ReportePrestadoresActivosResponseSchema = registry.register(
  'ReportePrestadoresActivosResponse',
  z.array(ReportePrestadoresActivosItemSchema)
);
...
registry.registerPath({
  ...
  description:
    'Obtiene un reporte que agrupa los eventos operativos por actividad, mostrando estadísticas de eventos y personas atendidas. Solo accesible para administradores.',
  tags: ['Reportes'],
  parameters: [
    {
      name: 'organizationId',
...
registry.registerPath({
  ...
  description:
    'Obtiene un reporte que agrupa los eventos operativos por prestador, mostrando estadísticas de eventos, personas atendidas y actividades realizadas. Solo accesible para administradores.',
  tags: ['Reportes'],
  parameters: [
    {
      name: 'organizationId',
...
registry.registerPath({
  ...
  description:
    'Obtiene un reporte que agrupa los eventos operativos por fecha, mostrando estadísticas diarias de eventos y personas atendidas. Requiere al menos una fecha (inicio o fin). Solo accesible para administradores.',
  tags: ['Reportes'],
  parameters: [
    {
      name: 'organizationId',
...
registry.registerPath({
  ...
  description:
    'Obtiene un reporte que muestra la capacidad utilizada vs disponible para cada actividad, fecha y bloque. Solo accesible para administradores.',
  tags: ['Reportes'],
  parameters: [
    {
      name: 'organizationId',
...
registry.registerPath({
  ...
  description:
    'Obtiene un reporte que muestra los prestadores activos, sus permisos vigentes y estadísticas de actividad. Solo accesible para administradores.',
  tags: ['Reportes'],
  parameters: [
    {
      name: 'organizationId',
