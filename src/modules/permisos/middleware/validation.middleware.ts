...
import {
  ...
  UpdatePermisoSchema,
  ListPermisosSchema,
  ListPrestadoresConPermisosPorAreaSchema,
 ...
 */
export const validateCreatePermiso = (req: Request, res: Response, next: NextFunction): void => {
  try {
 ...
 * @param next - NextFunction de Express
 */
export const validateUpdatePermiso = (req: Request, res: Response, next: NextFunction): void => {
  try {
    // Validar y transformar el body usando el schema Zod
 ...
 * @param next - NextFunction de Express
 */
export const validateListPermisos = (req: Request, res: Response, next: NextFunction): void => {
  try {
 ...
 */
export const validateListPrestadoresConPermisosPorArea = (
  req: Request,
  res: Response,
  next: NextFunction
): void => {
